...
|#|语法|效果|
|:---:|:---:|:---:|
|1|`[![zhihu-logo]](https://www.zhihu.com/people/Sitoi)`|[![zhihu-logo]](https://www.zhihu.com/people/Sitoi)|
|2|`[![](/img/zhihu.jpg "我的知乎，欢迎关注")][zhihu]`|[![](/img/zhihu.jpg "我的知乎，欢迎关注")][zhihu]|
|3|`[![zhihu-logo]][zhihu]`|[![zhihu-logo]][zhihu]|

因为图片本身和链接本身都支持 `URL` 标识符的形式，所以图片链接也可以很简洁（见例3）。
